<template>
    <div>
        <div class="container-fluid container-fixed-lg">
            <div class="row">
                <h4 class="section-title p-l-10">Examples</h4>
            </div>
        </div>
                    ...
                    <div class="card card-default">
                        <div class="card-header ">
                            ...
                            <div class="tools">
                                ...
                                <a class="config" data-toggle="modal" href="#grid-config"/>
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group transparent">
                                <div class="input-group-prepend">
                                    <span class="input-group-text transparent"><i class="fa fa-instagram"/>
                                    </span>
                                </div>
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text primary"><i class="fa fa-align-justify"/>
                                    </span>
                                </div>
                                <input type="text" placeholder="Username" class="form-control">
                            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <form class="" role="form">
                                <div id="sample-three" class="form-group form-group-default required typehead">
                        ...
                        <div class="col-md-4">
                            ...
                            <br>
                            <div id="custom-templates" class="form-group">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="input-group date col-md-8 p-l-0">
                                <input id="datepicker-component" type="text" class="form-control">
                                <div class="input-group-append ">
                        ...
                        <div class="col-lg-4">
                            ...
                            <br>
                            <div id="datepicker-range" class="input-daterange input-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group bootstrap-timepicker">
                                        ...
                                        <div class="input-group-append">
                                            <span class="input-group-text"><i class="pg-clock"/></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
